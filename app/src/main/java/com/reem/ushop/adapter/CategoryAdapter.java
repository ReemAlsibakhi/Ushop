...
public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull CategoryAdapter.ViewHolder holder, final int position) {
        ...
        Glide.with(mContext).load(category.getImage()).centerCrop().override(20, 20).into(holder.binding.imgCategory);
        ...
        holder.binding.linear.setBackgroundColor(selectedPos == position ? mContext.getResources().getColor(R.color.colorPrimary) : mContext.getResources().getColor(R.color.white));
